    ...
    <footer className='max-container'>
      <div className='flex justify-between items-start gap-20 flex-wrap max-lg:flex-col'>
        <div className='flex flex-col items-start'>
          ...
          <p className='text-white-400 font-montserrat leading-7 mt-6 text-base sm:max-w-sm'>Get shoes 
          ready for the new term at your 
      ...
      <div className='flex justify-between text-white-400 mt-24 max-sm:flex-col  max-sm:items-center'>
              <div className='flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer'>
                  ...
                  <p className='font-montserrat cursor-pointer font-bold'>Copyright. All right reserved</p>
              </div>
              <p className='font-montserrat cursor-pointer font-bold '>Terms & Conditions</p>
      </div>
    </footer>
  )
}
